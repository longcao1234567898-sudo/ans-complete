...
export interface AIAnalysisResult {
  /** false = hệ thống chưa xác định được bà con trình báo việc gì */
  duRo?: boolean;
  /** Lý do khi duRo = false */
  lyDo?: string;
  /** Gợi ý cụ thể những thông tin còn thiếu */
  goiY?: string[];
...
export interface ContactInfo {
  ...
  otpToken?: string;
  /** Mã phiên của luồng gửi ẩn danh — gửi kèm để máy chủ đối chiếu "vé" */
  anonId?: string;
...
export interface FeedbackDraft {
  content: string;
  /** Mức khẩn cấp do người dân tự chọn */
